...
kge_ko1$성조 %>% table()
#고유어 1에 대한 전체분석
kge_ko1 %>% kge_chisq_table("a1","성조") #onset

kge_ko1 %>% kge_chisq_table("a3","성조") #coda

kge_ko1 %>% kge_chisq_table("W","성조") #wegitht

##
kge_ko2 %>% kge_chisq_table("a1","성조")
kge_ko3 %>% kge_chisq_table("a1","성조")


#고유어1에 대한 테이블
kge_ko1 %>% kge_chisq_table("a1","성조", type = "ct")
#독립성 검정
kge_ko1 %>% kge_chisq_table("a1","성조", type = "res1")
kge_ko1 %>% kge_chisq_table("a1","성조", type = "margin") #%>% markdown_table()
kge_ko1 %>% kge_chisq_table("a1","성조", type = "chitable") #%>% markdown_table()
kge_ko1 %>% kge_chisq_table("a1","성조", type = "chisq_test") #%>% markdown_table()


#회귀분석
lm(Freq ~ 성조 + a1 ,
   data = kge_ko1 %>%
     kge_chisq_table("a1","성조", type = "df") ) %>% summary()
...
kge_ko1 %>% kge_chisq_table("a1","성조","고유어1 onset/accent")
kge_ko1 %>% kge_chisq_table("a3","성조","고유어1 coda/accent")


# 고유어2----
kge_ko2 %>% kge_chisq_table("a1","성조","고유어2에 관한 ")
kge_ko2 %>% kge_chisq_table("b3","성조","고유어2 coda/accent ")
# sig ***
lmer(Freq ~ a1 + 성조 + (1|성조) ,
     data = kge_ko1 %>% #rename(onset = a1, accent= 성조) %>%
       kge_chisq_table("a1","성조", type = "df") ) %>% lme_report()


kge_ko3 %>% kge_chisq_table("a1","성조","고유어3에 관한 ")
kge_ko3 %>% kge_chisq_table("b3","성조","고유어3 coda/accent ")


kge_fo2 %>% kge_chisq_table("a1","성조","외래어2 onset/accent")
kge_fo2 %>% kge_chisq_table("b3","성조","외래어2 coda/accent ")

# 고유어2----
kge_fo3 %>% kge_chisq_table("a1","성조","외래어3에 관한 ")
kge_fo3 %>% kge_chisq_table("b3","성조","외래어3 coda/accent ")


kge_fo4 %>% kge_chisq_table("a1","성조","외래어4에 관한 ")
kge_fo4 %>% kge_chisq_table("b3","성조","외래어4 coda/accent ")
